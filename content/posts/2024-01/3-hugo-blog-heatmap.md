...
--- 
## 1/15 更新 - 每天多篇文章
有博友在我的基础上修改了每天多篇文章的显示，想到我确实偶尔每天写多篇文章，而且在发布之后还真有那么几天想到“今天已经发过了，heatmap 显示不出等于没写“于是就推后写了（其实明明大家都是从别的 entrypoint 进来的很少有人看 heatmap），所以也立刻以[博友的代码](https://blog.liminalnegativespace.xyz/posts/heatmap/utm_source=blog.douchi.space)为参考把我的也改成一天可显示多篇文章了。懒得逐条 version control 和修改就不逐步展开了，以下是新版代码：
