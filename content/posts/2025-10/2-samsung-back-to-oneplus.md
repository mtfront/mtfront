...
- **一体机身不会再老误弹出 S-pen 了**：S-pen 对我唯一的用处就是相机遥控，也总共没用过几次还不一定每次都 work。倒是老误触把它弹出来，一是降低了防水性二是容易丢/折。一加没有 S-pen 就没这个问题了，也完全没有怀念过 S-pen 的功能。
...
- **Shortcut/routine 能力有限**：我在三星也就有 N 点之后自动调整音量（洗澡时候全音量听播客之后第二天不被震聋），链接 Android Auto 后自动播放固定 playlist（在车上不喜欢听播客），打开 wallet 之后自动打开 NFC 这三个 routine/shortcut，一加的替换功能没有三星的好定制，于是还没花时间研究到底能不能达到等效效果。
